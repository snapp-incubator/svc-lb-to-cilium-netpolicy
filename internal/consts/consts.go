...
const (
	...
	NamespaceExcludedNoPolicyMatchInfo  string             = "Namespace matched against \"no existing unmanaged CiliumNetworkPolicy and NetworkPolicy object\" rule"
	NamespaceExclusionGetNamespaceError string             = "failed to get Namespace object: %w"
	NamespaceExclusionStateError        string             = "failed to detect Namespace exclusion state: %w"
